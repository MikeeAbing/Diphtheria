...
const PrintCIF = () => {
  ...
  const FormHeader = () => (
  <div className="grid grid-cols-3 items-center mt-0 mb-0">
    <div className="flex items-center gap-1">
      <img src="/images/pidsr-logo.png" alt="PIDSR Logo" className="w-[50px] h-[50px]" />
    ...
    <div className="text-center leading-tight">
      <h2 className="text-[11pt] leading-none">Case Investigation Form</h2>
      <h3 className="text-[12pt] font-[Arial Black] font-bold leading-none">Diphtheria</h3>
      <p className="text-[10pt] leading-none">(ICD 10 Code: A36)</p>
    </div>

    <div className="flex flex-col items-end text-right">
      <p className="text-[9pt] font-bold">Version 2019</p>
      <img src="/images/doh-icon.png" alt="Form Icon" className="w-[45px] h-[45px] mt-0" />
    </div>
  </div>
);
  ...
  return (
    <div className="p-2">
      ...
      <div
        ref={contentRef}
        className="bg-white p-5 max-w-[210mm] min-h-[297mm] mx-auto text-black text-[9pt] font-[Arial] border"
      >
        <FormHeader />
        ...
        <div className="border-r border-l border-black">
          <h4 className="font-bold bg-gray-100 p-0 border-b border-black">A. PATIENT INFORMATION</h4>
          ...
          <div className="grid grid-cols-6 text-[9pt] border-b border-black">
            ...
            <div className="col-span-2 pl-1 border-r border-black">
              ...
              <p>Pregnant? {patient?.pregnancy_status === 'Y' ? '☑' : '☐'} Y &nbsp;&nbsp; {patient?.pregnancy_status === 'N' ? '☑' : '☐'} N &nbsp;&nbsp; {patient?.pregnancy_status === 'U' ? '☑' : '☐'} U</p>       
              <p>If yes, weeks of pregnancy _______________________________</p>
              <p>Civil Status: {patient.civil_status === 'S' ? '☑' : '☐'} Single &nbsp;&nbsp; {patient.civil_status === 'M' ? '☑' : '☐'} Married &nbsp;&nbsp; {patient.civil_status === 'W' ? '☑' : '☐'} Widowed &nbsp;&nbsp; {patient.civil_status === 'L' ? '☑' : '☐'} Legally Separated</p>
            </div>
            ...
            <div className="col-span-1 text-center pr-2">
              <p className="mb-1 mt-1 ml-1">Age: {patient?.ageinyears} y.o.</p>
              <p><p className='ml-1 border-solid border-3 w-7 h-5'>{patient?.ageindays}&nbsp;&nbsp;&nbsp;Days</p> <br /> <p className='ml-1 border-solid border-3 w-7 h-5'>{patient?.ageinmonths}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Months</p> <br /> <p className='ml-1 border-solid border-3 w-7 h-5'>{patient?.ageinyears}&nbsp;&nbsp;&nbsp;Years</p></p>
              <p></p>
            </div>
          </div>
        ...
        <div className="border-r border-l border-black">
          <h3 className="font-bold bg-gray-100 p-0 border-b border-black">II. BACKGROUND INFORMATION</h3>
        ...
        <div className="border-r border-l border-black">
          <h3 className="font-bold bg-gray-100 p-0 border-b border-black">III. CLINICAL DETAILS</h3>
          <div className="text-[9pt] border-b border-black">
            ...
            <div className="border-t border-black">
              <p className="mt-2">☐ Others, specify _____________</p>
            </div>
          </div>
        </div>

        <div className="border-r border-l border-black">
          <h3 className="font-bold bg-gray-100 p-0 border-b border-black">IV. TREATMENT INFORMATION</h3>
          <div className="text-[9pt] border-b border-black">
        ...
        <div className="border-r border-l border-black">
          <h3 className="font-bold bg-gray-100 p-0 border-b border-black">V. SPECIMEN COLLECTION</h3>
          <div className="text-[9pt] border-b border-black">
            <div className="grid grid-cols-6 p-1 border-b border-black">
            ...
            <p className="mt-1">If positive </p>
            <p className="mb-1">{diph?.cough === 'Y' ? '☑' : '☐'} Toxigenic &nbsp;&nbsp; {diph?.pseudomembrane === 'Y' ? '☑' : '☐'} Non-toxigenic</p>

          </div>
        </div>

        <div className="grid grid-cols-6 border-r border-l border-black">
          <h3 className="col-span-2 font-bold p-0 border-b border-black">VI. FINAL CLASSIFICATION</h3>
          <p className="col-span-4 p-0 border-b border-black">{diph?.known_exposure === '1' ? '☑' : '☐'} Positive &nbsp;&nbsp; {diph?.known_exposure === '2' ? '☑' : '☐'} Negative &nbsp;&nbsp; {diph?.known_exposure === '3' ? '☑' : '☐'} Undetermined &nbsp;&nbsp; {diph?.known_exposure === '4' ? '☑' : '☐'} Not processed</p>
        </div>

        <div className="border-r border-l border-black">
          <h3 className="font-bold bg-gray-100 p-0 border-b border-black">To include linelist for close contacts</h3>
        </div>

        <div className="text-[9pt] font-bold text-gray-700">
